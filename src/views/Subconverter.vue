...
const defaultBackend = "https://sub.ishadows.cn/sub?";
...
export default {
  ...
  mounted() {
    ...
    this.form.customBackend = "https://sub.ishadows.cn/sub?";
    this.form.remoteConfig = "https://raw.githubusercontent.com/zhongfly/clash/master/ACL4SSR_Netease.ini";
    this.notify();
